  ...
  return (
    <div style={{ background: "#1a1a1a", borderRadius: 20, overflow: "hidden", border: "1px solid rgba(212,175,120,0.15)", maxWidth: 440, width: "100%", boxShadow: "0 24px 80px rgba(0,0,0,0.5)" }}>
      ...
      <div style={{ padding: "16px 20px", background: "linear-gradient(135deg, #1e1e1e, #252525)", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", gap: 12 }}>
        <div style={{ width: 40, height: 40, borderRadius: 12, background: "linear-gradient(135deg, #d4af78, #c49a5c)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}>M</div>
        <div>
          <div style={{ fontSize: 14, fontWeight: 700, color: "#f0e6d6", fontFamily: "'Playfair Display',serif" }}>Marcel</div>
          <div style={{ fontSize: 11, color: "#7a7a6a", display: "flex", alignItems: "center", gap: 4 }}>
      ...
      <div style={{ display: "flex", gap: 0, borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        {convTabs.map(t => (
          <button key={t.id} onClick={() => setActiveConv(t.id)} style={{
            ...
            border: "none", borderBottom: activeConv === t.id ? "2px solid #d4af78" : "2px solid transparent",
            color: activeConv === t.id ? "#d4af78" : "#6a6a5a", fontSize: 11, fontWeight: 700, cursor: "pointer",
        ...
        {msgs.slice(0, visibleMsgs).map((msg, i) => (
          <div key={`${activeConv}-${i}`} style={{
            ...
            <div style={{
              ...
              background: msg.role === "guest" ? "linear-gradient(135deg, #d4af78, #c49a5c)" : "rgba(255,255,255,0.06)",
        ...
        {isTyping && (
          <div style={{ alignSelf: "flex-start", animation: "msgIn .2s ease" }}>
            <div style={{ padding: "10px 18px", borderRadius: "16px 16px 16px 4px", background: "rgba(255,255,255,0.06)", display: "flex", gap: 4 }}>
              {[0,1,2].map(i => <span key={i} style={{ width: 7, height: 7, borderRadius: "50%", background: "#d4af78", animation: `dotPulse .8s ease ${i * 0.15}s infinite` }}></span>)}
            </div>
          </div>
        )}
      </div>
...
function SectionLabel({ children }) {
  return <div style={{ fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: 3, color: "#d4af78", marginBottom: 12, fontFamily: "'DM Sans',sans-serif" }}>{children}</div>;
}
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans','Segoe UI',sans-serif", background: "#0f0f0e", color: "#e8e0d0", minHeight: "100vh", overflowX: "hidden" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700;800;900&family=DM+Sans:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;700&display=swap');
        *{box-sizing:border-box;margin:0;padding:0}
        html{scroll-behavior:smooth}
        ::-webkit-scrollbar{width:4px}::-webkit-scrollbar-track{background:transparent}::-webkit-scrollbar-thumb{background:rgba(212,175,120,0.2);border-radius:2px}
        ...
        a{color:#d4af78;text-decoration:none}a:hover{text-decoration:underline}
      `}</style>
      ...
      <nav style={{
        ...
        background: "rgba(15,15,14,0.85)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(212,175,120,0.08)"
      }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{
            width: 32, height: 32, borderRadius: 8, background: "linear-gradient(135deg, #d4af78, #c49a5c)",
            display: "flex", alignItems: "center", justifyContent: "center",
            fontFamily: "'Playfair Display',serif", fontSize: 16, fontWeight: 800, color: "#0f0f0e"
          }}>M</div>
          <span style={{ fontFamily: "'Playfair Display',serif", fontSize: 18, fontWeight: 700, color: "#f0e6d6" }}>Marcel</span>
        </div>
        <div style={{ display: "flex", gap: 28, alignItems: "center" }}>
          {[["Come funziona","#come-funziona"],["Demo","#demo"],["Prezzi","#prezzi"],["Contatti","#contatti"]].map(([l,h]) =>
            <a key={l} href={h} style={{ fontSize: 13, color: "#8a8a7a", fontWeight: 600, textDecoration: "none", transition: "color .2s" }}
              onMouseEnter={e=>e.target.style.color="#d4af78"} onMouseLeave={e=>e.target.style.color="#8a8a7a"}>{l}</a>
          )}
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at 30% 20%, rgba(212,175,120,0.06) 0%, transparent 60%), radial-gradient(ellipse at 70% 80%, rgba(212,175,120,0.03) 0%, transparent 50%)"
      }}>
        ...
        <div style={{ maxWidth: 1100, width: "100%", display: "flex", alignItems: "center", gap: 60, flexWrap: "wrap", justifyContent: "center", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ flex: "1 1 480px", minWidth: 320, animation: "fi .8s ease" }}>
            <div style={{ fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: 3, color: "#d4af78", marginBottom: 20 }}>
              AI Concierge per Hotel Boutique
            </div>
            <h1 style={{
              fontFamily: "'Playfair Display',serif", fontSize: "clamp(36px, 5vw, 56px)",
              fontWeight: 800, lineHeight: 1.1, color: "#f5efe5", marginBottom: 24, letterSpacing: -1
            }}>
              Il vostro concierge<br/>
              <span style={{ color: "#d4af78" }}>che non dorme mai.</span>
            </h1>
            <p style={{ fontSize: 17, lineHeight: 1.7, color: "#9a9a8a", marginBottom: 32, maxWidth: 520 }}>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 40 }}>
              <a href="#contatti" style={{
                ...
                boxShadow: "0 4px 24px rgba(212,175,120,0.25)"
              }}>Richiedi demo gratuita</a>
              <a href="#demo" style={{
                padding: "14px 32px", borderRadius: 10, fontWeight: 700, fontSize: 15,
            ...
            <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
              {[["Nessun codice richiesto","🚀"],["Setup in 48 ore","⚡"],["ROI dal primo mese","📈"]].map(([t,i]) =>
                <div key={t} style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: "#7a7a6a" }}>
      ...
      {/* ─── STATS BAR ─── */}
      <div style={{ borderTop: "1px solid rgba(212,175,120,0.08)", borderBottom: "1px solid rgba(212,175,120,0.08)", background: "rgba(212,175,120,0.02)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-around", flexWrap: "wrap", padding: "40px 24px" }}>
          {STATS.map((s, i) => (
            <div key={i} style={{ textAlign: "center", padding: "12px 24px", minWidth: 140 }}>
              <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 36, fontWeight: 800, color: "#d4af78" }}>{s.value}</div>
      ...
      <Section>
        <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: 32, fontWeight: 700, lineHeight: 1.3, color: "#f0e6d6", marginBottom: 24 }}>
            I vostri ospiti hanno domande.<br/>A qualsiasi ora.
          </h2>
          <p style={{ fontSize: 16, lineHeight: 1.8, color: "#8a8a7a", marginBottom: 32 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16 }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ fontSize: 13, color: "#7a7a6a", lineHeight: 1.6 }}>{b.text}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ─── COME FUNZIONA ─── */}
      <Section id="come-funziona" style={{ background: "rgba(212,175,120,0.02)" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <SectionLabel>Come funziona</SectionLabel>
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: 32, fontWeight: 700, color: "#f0e6d6" }}>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ position: "relative" }}>
                <div style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: 2, color: "#d4af78", marginBottom: 12 }}>{s.time}</div>
                <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 20, fontWeight: 700, color: "#f0e6d6", marginBottom: 12 }}>{s.title}</h3>
                <p style={{ fontSize: 14, lineHeight: 1.7, color: "#7a7a6a" }}>{s.desc}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 16 }}>
          {FEATURES.map((f, i) => (
            <div key={i} style={{
              ...
              <p style={{ fontSize: 13, lineHeight: 1.7, color: "#7a7a6a" }}>{f.desc}</p>
            </div>
          ))}
        </div>
      </Section>
      ...
      {/* ─── TESTIMONIALS ─── */}
      <Section style={{ background: "rgba(212,175,120,0.02)" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
        ...
        <div style={{ display: "flex", gap: 20, flexWrap: "wrap", justifyContent: "center" }}>
          {TESTIMONIALS.map((t, i) => (
            <div key={i} style={{
              ...
              <div style={{ color: "#d4af78", fontSize: 16, marginBottom: 12, letterSpacing: 2 }}>{"★".repeat(t.stars)}</div>
      ...
      <Section id="prezzi">
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 14, color: "#7a7a6a", marginTop: 12 }}>Setup una tantum + canone mensile. Disdici quando vuoi.</p>
        </div>
        <div style={{ display: "flex", gap: 16, flexWrap: "wrap", justifyContent: "center" }}>
          {PRICING.map((p, i) => (
            <div key={i} style={{
              ...
              <div style={{ fontSize: 13, fontWeight: 700, color: "#d4af78", marginBottom: 4 }}>{p.name}</div>
              <div style={{ fontSize: 12, color: "#6a6a5a", marginBottom: 20 }}>{p.desc}</div>
              <div style={{ marginBottom: 4 }}>
                <span style={{ fontFamily: "'Playfair Display',serif", fontSize: 40, fontWeight: 800, color: "#f0e6d6" }}>€{p.monthly}</span>
                <span style={{ fontSize: 14, color: "#6a6a5a" }}>/mese</span>
              </div>
              <div style={{ fontSize: 12, color: "#7a7a6a", marginBottom: 24 }}>
                Setup: <b style={{ color: "#d4af78" }}>€{p.setup}</b> una tantum
              </div>
              <div style={{ marginBottom: 24 }}>
                {p.features.map((f, j) => (
                  <div key={j} style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 10, fontSize: 13, color: "#a0a090" }}>
                    <span style={{ color: "#d4af78", fontSize: 14, lineHeight: 1, marginTop: 1 }}>✓</span>
                    <span>{f}</span>
                  </div>
                ))}
              </div>
              <a href="#contatti" style={{
                display: "block", textAlign: "center", padding: "12px 24px", borderRadius: 10, fontWeight: 700, fontSize: 14,
                background: p.popular ? "linear-gradient(135deg, #d4af78, #c49a5c)" : "transparent",
                color: p.popular ? "#0f0f0e" : "#d4af78",
      ...
      <Section style={{ background: "rgba(212,175,120,0.02)" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: 28, fontWeight: 700, color: "#f0e6d6", marginBottom: 32 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, textAlign: "left" }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 20, fontWeight: 700, color: i === 5 ? "#d4af78" : "#f0e6d6" }}>{r.value}</div>
              </div>
            ))}
          </div>
          <div style={{
            ...
            <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 24, fontWeight: 700, color: "#d4af78" }}>ROI: 12x</div>
            <div style={{ fontSize: 13, color: "#8a8a7a", marginTop: 4 }}>Per ogni euro investito in Marcel, ne recuperate dodici in revenue e risparmio operativo.</div>
          </div>
        </div>
      </Section>
      ...
      <Section id="contatti">
        <div style={{ maxWidth: 560, margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: 32, fontWeight: 700, color: "#f0e6d6", marginBottom: 12 }}>
            Provate Marcel nel vostro hotel.
          </h2>
          <p style={{ fontSize: 15, color: "#7a7a6a", marginBottom: 36 }}>
          ...
          {!formSent ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                { ph: "Nome e cognome", type: "text" },
                { ph: "Nome dell'hotel", type: "text" },
                { ph: "Email", type: "email" },
                { ph: "Telefono (opzionale)", type: "tel" },
              ].map((f, i) => (
              ...
              <select style={{
                padding: "14px 18px", borderRadius: 10, border: "1px solid rgba(255,255,255,0.08)",
                background: "rgba(255,255,255,0.03)", color: "#8a8a7a", fontSize: 14,
                fontFamily: "'DM Sans',sans-serif", outline: "none"
              }}>
                <option>Quante camere ha il vostro hotel?</option>
              ...
              <button onClick={async () => { const form = document.querySelector('form'); await fetch('https://formspree.io/f/xAbCdEfG', {method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({name: document.querySelectorAll('input')[0].value, hotel: document.querySelectorAll('input')[1].value, email: document.querySelectorAll('input')[2].value, phone: document.querySelectorAll('input')[3].value})}); setFormSent(true); }} style={{
                ...
                boxShadow: "0 4px 24px rgba(212,175,120,0.3)", transition: "transform .2s"
              }}>Richiedi la demo gratuita →</button>
            ...
            <div style={{
              ...
              <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 24, fontWeight: 700, color: "#d4af78", marginBottom: 8 }}>Grazie!</h3>
              <p style={{ fontSize: 15, color: "#8a8a7a" }}>Vi contatteremo entro 24 ore con una demo personalizzata per il vostro hotel.</p>
            </div>
          )}
        </div>
      </Section>
      ...
      {/* ─── FOOTER ─── */}
      <footer style={{
        padding: "40px 24px", borderTop: "1px solid rgba(212,175,120,0.08)",
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
              <div style={{
                width: 24, height: 24, borderRadius: 6, background: "linear-gradient(135deg, #d4af78, #c49a5c)",
                display: "flex", alignItems: "center", justifyContent: "center",
                fontFamily: "'Playfair Display',serif", fontSize: 12, fontWeight: 800, color: "#0f0f0e"
              }}>M</div>
              <span style={{ fontFamily: "'Playfair Display',serif", fontSize: 15, fontWeight: 700, color: "#f0e6d6" }}>Marcel Concierge</span>
            </div>
